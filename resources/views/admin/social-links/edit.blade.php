                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('social-links.update') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="url" name="twitter" class="form-control" id="twitter" value="{{ $socialLinks->twitter }}" placeholder="Masukkan URL Twitter">
                        </div>
                        <div class="mb-4">
                            <label for="facebook" class="form-label">Facebook</label>
                            <input type="url" name="facebook" class="form-control" id="facebook" value="{{ $socialLinks->facebook }}" placeholder="Masukkan URL Facebook">
                        </div>
                        <div class="mb-4">
                            <label for="instagram" class="form-label">Instagram</label>
                            <input type="url" name="instagram" class="form-control" id="instagram" value="{{ $socialLinks->instagram }}" placeholder="Masukkan URL Instagram">
                        </div>
                        <div class="mb-4">
                            <label for="youtube" class="form-label">YouTube</label>
                            <input type="url" name="youtube" class="form-control" id="youtube" value="{{ $socialLinks->youtube }}" placeholder="Masukkan URL YouTube">
                        </div>
                        <div class="mb-4">
