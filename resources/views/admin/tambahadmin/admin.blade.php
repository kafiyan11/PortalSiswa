...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-10 col-md-9 offset-lg-2 offset-md-3 content">
            <h1 class="text-primary">Data Admin</h1>

            <!-- Tombol Tambah Admin dan Pencarian -->
            <div class="d-flex justify-content-between align-items-center mb-3">
                <!-- Tombol Tambah Admin -->
                <a href="{{ route('create.admin') }}" class="btn btn-success">
                    <i class="fas fa-plus"></i> Tambah Admin
                </a>

                <!-- Form Pencarian -->
                <form action="{{ route('tambah.admin') }}" method="GET" class="form-inline">
            ...
            <div class="table-responsive">
                ...
                <div class="col-md-6">
                    <p>Total Admin: <span class="badge badge-primary">{{ $totalAdmin }}</span></p> <!-- Menampilkan jumlah siswa -->
                </div>
