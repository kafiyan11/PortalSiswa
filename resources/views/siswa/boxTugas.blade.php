...
<div class="container">
    ...
    <div class="subject-container">
        @if($tugas && $tugas->isNotEmpty())
            @foreach($tugas as $item)
                <div class="subject-box" onclick="window.location.href='{{ route('siswa.tugas', ['id_mapel' => $item->id_mapel]) }}'">
            ...
            @endforeach
        @else
            <p class="text-center">Tidak ada tugas tersedia.</p> <!-- Pesan jika tidak ada materi -->
        @endif
    </div>
</div>
@endsection
