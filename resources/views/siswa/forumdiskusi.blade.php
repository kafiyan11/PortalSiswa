    ...
    @endif
                ...
                <div class="card-footer bg-white border-0">
                    ...
                    <div class="comment-box">
                        ...
                        <form id="delete-comment-form-{{ $comment->id }}" action="{{ route('siswa.comment.destroy', $comment->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                    ...
                    <div class="reply-form">
                        <form action="{{ route('siswa.comment.store', $post->id) }}" method="POST">
                            @csrf
                            <div class="input-group mb-2">
